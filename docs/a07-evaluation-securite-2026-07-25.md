...
**Périmètre :** API/web, continuité Web Push, provenance Render et client Android<br>
**Données :** aucune donnée d’enfant, aucun secret fournisseur affiché<br>
**Décision :** constats techniques élevés corrigés ; A07 reste ouverte pour les essais fournisseur et appareils réels.
