...
| A07 | **Rouverte** | Rapport historique ; nouvelle évaluation locale du 25 juillet ; suite Node, audit npm, build web, lint Android et APK 1.12 public | Les quatre erreurs Android trouvées ont été corrigées, mais les essais réels RTC, Web Push, FCM, APNs/PushKit et appareils verrouillés restent nécessaires ; l’APK conserve encore l’identité de signature Android de test |
